...
// #[cfg(unix)]
// pub async fn check_email_contains_email_fn(file_path: &Path) -> bool {
//     let url_regex = Regex::new(r"(https?://)?([a-zA-Z0-9.-]*mail\.google\.com)")
...
//         println!("No email found in image");
//         return false;
//     }

//     println!("Email found in image: {:?}", domains_found);
//     return true;
// }
